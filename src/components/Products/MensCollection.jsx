  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container px-4 mx-auto">
        <h2 className="text-4xl font-extrabold text-center mb-12 text-blue-700 dark:text-blue-300 tracking-wide">
          👔 Men's Collection
        </h2>
          ...
          {mensCollection.map((product) => (
            ...
            >
              ...
              <Link
                ...
                state={{ from: "Men" }}
                className="mt-6 inline-block w-full text-center bg-blue-600 text-white font-medium py-2.5 px-4 rounded-full hover:bg-blue-700 transition-colors duration-300"
              >
                Buy Now
              </Link>
            </div>
